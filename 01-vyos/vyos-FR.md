...
On peut désormais faire notre nouveau clone avec pour options :

> Générer de nouvelles adresses MAC pour toutes les interfaces réseau.

On démarre notre nouveau clone afin de vérifier l'homogénéité des adresses.

Les interfaces de la machine virtuelle commencent bien à partir de `eth0` et sont incrémentées de 1.
